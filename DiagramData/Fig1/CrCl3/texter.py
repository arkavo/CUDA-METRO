...
blm_512 = np.load("BLM_64_512.npy")/1.5
blm_1024 = np.load("BLM_64_1024.npy")/1.5
blm_2048 = np.load("BLM_64_2048.npy")/1.5
blm_4096 = np.load("BLM_64_4096.npy")/1.5
...
bl = pd.DataFrame(np.transpose(np.array([blx_512/np.max(blx_512),blx_1024/np.max(blx_1024),blx_2048/np.max(blx_2048),blx_4096/np.max(blx_4096)])), columns=["512","1024","2048","4096"])
bl.to_csv(f"csvs/BLX_CrCl3.csv", index=False)

GreenL = np.loadtxt("GREENCLM.txt", delimiter=",")
grm_512 = np.load("BQM_64_512.npy")/1.5
grm_1024 = np.load("BQM_64_1024.npy")/1.5
grm_2048 = np.load("BQM_64_2048.npy")/1.5
grm_4096 = np.load("BQM_64_4096.npy")/1.5
...
gr = pd.DataFrame(np.transpose(np.array([grx_512/np.max(grx_512),grx_1024/np.max(grx_1024),grx_2048/np.max(grx_2048),grx_4096/np.max(grx_4096)])), columns=["512","1024","2048","4096"])
