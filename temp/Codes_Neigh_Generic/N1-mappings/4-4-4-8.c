...
int i;
    ...
    for ( i = 0; i < 4; i++) {
        ...
        int neighborIndex = neighborRow * N + neighborCol -1;
        fprintf(fptr,"%d ", matrix[neighborIndex]);
...
int i;
    FILE *fptr;
   fptr= fopen("C:\\Users\\deric\\OneDrive - Indian Institute of Science\\Desktop\\Major_Project\\Codes_Neigh_Generic\\output4.txt","w"); 
         if(fptr == NULL)
   {
      printf("Error!");   
      exit(1);             
