...
Fig 1: Discrepancy between reference and reference[@Wahab2021-pb] results at differing levels of parallelization. At $10\%$, the simulation results are almost indistinguishable from the reference data. 
